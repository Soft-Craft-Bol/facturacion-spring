...
public interface DetalleProduccionInsumoCrudRepository extends JpaRepository<DetalleProduccionInsumoEntity, Long> {
    List<DetalleProduccionInsumoEntity> findByMovimientoProduccionId(Long movimientoProduccionId);
    void deleteByMovimientoProduccionId(Long movimientoProduccionId);
}