 ...
 * generated in the bo.gob.impuestos.siat.api.servicio.facturacion.compra.venta package. 
...
public class ObjectFactory {
    ...
    private final static QName _RecepcionAnexos_QNAME = new QName("https://siat.impuestos.gob.bo/", "recepcionAnexos");
    private final static QName _RecepcionAnexosResponse_QNAME = new QName("https://siat.impuestos.gob.bo/", "recepcionAnexosResponse");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: bo.gob.impuestos.siat.api.servicio.facturacion.compra.venta
     * 
     */
    ...
    /**
     * Create an instance of {@link RecepcionAnexos }
     * 
     */
    public RecepcionAnexos createRecepcionAnexos() {
        return new RecepcionAnexos();
    }

    /**
     * Create an instance of {@link RecepcionAnexosResponse }
     * 
     */
    public RecepcionAnexosResponse createRecepcionAnexosResponse() {
        return new RecepcionAnexosResponse();
    }
    ...
    /**
     * Create an instance of {@link SolicitudRecepcionAnexos }
     * 
     */
    public SolicitudRecepcionAnexos createSolicitudRecepcionAnexos() {
        return new SolicitudRecepcionAnexos();
    }

    /**
     * Create an instance of {@link VentaAnexo }
     * 
     */
    public VentaAnexo createVentaAnexo() {
        return new VentaAnexo();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link RecepcionAnexos }{@code >}
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link RecepcionAnexos }{@code >}
     */
    @XmlElementDecl(namespace = "https://siat.impuestos.gob.bo/", name = "recepcionAnexos")
    public JAXBElement<RecepcionAnexos> createRecepcionAnexos(RecepcionAnexos value) {
        return new JAXBElement<RecepcionAnexos>(_RecepcionAnexos_QNAME, RecepcionAnexos.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link RecepcionAnexosResponse }{@code >}
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link RecepcionAnexosResponse }{@code >}
     */
    @XmlElementDecl(namespace = "https://siat.impuestos.gob.bo/", name = "recepcionAnexosResponse")
    public JAXBElement<RecepcionAnexosResponse> createRecepcionAnexosResponse(RecepcionAnexosResponse value) {
        return new JAXBElement<RecepcionAnexosResponse>(_RecepcionAnexosResponse_QNAME, RecepcionAnexosResponse.class, null, value);
    }
